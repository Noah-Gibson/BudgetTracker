...
function CreditCardPaymentsPanel({ vault, onChange }: { vault: BudgetVault; onChange: (vault: BudgetVault) => void }) {
  const [name, setName] = useState(""); const [dueDay, setDueDay] = useState<number | null>(null); const [editing, setEditing] = useState<CreditCardPayment | null>(null); const [error, setError] = useState("");
